	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" action="{{ U('Admin/Shipping/index') }}" method="get">
				<div class="sDiv">
					<div class="sDiv2">
						<input size="30" name="shipping_name" value="{{ \think\Request::instance()->param('shipping_name') }}" class="qsbox" placeholder="快递公司名称" type="text">
					</div>
					<div class="sDiv2">
						<input type="text" size="30" name="shipping_code" value="{{ \think\Request::instance()->param('shipping_code') }}" class="qsbox" placeholder="物流编号">
