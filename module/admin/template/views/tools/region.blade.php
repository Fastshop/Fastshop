	...
	<div id="list">
		...
		<div class="flexigrid">
			<div class="mDiv">
				<div class="ftitle">
					<h3>地区列表</h3>
					<h5>(共{{ count($region) }}张记录)</h5>
				</div>
				<div title="刷新数据" class="pReload"><i class="fa fa-refresh"></i></div>
				@if(!tp_empty($parent_path)) <div title="上级区域" class="pReload">上级区域:{{ $parent_path }}</div> @endif 
			</div>
			<div class="hDiv">
				<div class="hDivBox">
...
<script>
	@if(\think\Request::instance()->param('op') == 'add') 
			add_region(1);
	 @endif 
