      ...
      <div class="sDiv">
        <div class="sDiv2">
          <select  name="cat_id" class="select">
            ...
            <option value="{{ $vo['cat_id'] }}" @if($vo['cat_id'] == $cat_id) selected @endif >{{ $vo['cat_name'] }}</option>
          ...
          <tbody>
            @foreach( $list ?: [] as $k => $vo )
              ...
              <tr>
                ...
                <td align="left" class="">
                  <div style="text-align: left; width: 240px;">{{ getSubstr($vo['title'],0,33) }}</div>
                </td>
                <td align="left" class="">
                ...
                <td align="center" class="handle">
                  <div style="text-align: center; width: 170px; max-width:170px;"> <a class="btn blue" target="_blank" href="{{ U('Home/Article/detail',array('article_id'=>$vo['article_id'])) }}"><i class="fa fa-search"></i>查看</a>
                    @if(!in_array(($vo['article_id']), is_array($article_able_id) ? $article_able_id : explode(',',$article_able_id)))  <a class="btn red"  href="javascript:void(0)" data-url="{{ U('Article/aticleHandle') }}" data-id="{{ $vo['article_id'] }}" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>  @endif 
                    @if(in_array(($vo['article_id']), is_array($article_able_id) ? $article_able_id : explode(',',$article_able_id)))  <a class="btn red"  href="javascript:;" onclick="layer.alert('系统文章不得删除!',{icon:2});"><i class="fa fa-trash-o"></i>删除</a>  @endif 
