...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
            ...
            <ul class="tab-base nc-row">
                <li><a @if($_REQUEST['mtype']  != -1) class= 'current' @endif   href="{{ U('admin/goods/StockList?mtype=1') }}"><span>入库日志</span></a></li>
                <li><a @if($_REQUEST['mtype'] == -1) class= 'current' @endif  href="{{ U('admin/goods/StockList?mtype=-1') }}"><span>出库日志</span></a></li>
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="search-form" method="get" action="{{ U('Goods/stockList') }}" onsubmit="return check_form();">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2" style="margin-right: 10px;">
                        <select class="form-control" id="status" name="mtype" style="border: none;">
                            ...
                            <option value="1" @if($_REQUEST['mtype'] == 1) selected @endif >入库</option>
                            <option value="-1" @if($_REQUEST['mtype'] == -1) selected @endif >出库</option>
                        </select>
                    </div>
                    <div class="sDiv2">
                        <input size="30" placeholder="商品名称" value="{{ \think\Request::instance()->get('goods_name') }}" name="goods_name" class="qsbox" type="text">
                    ...
                    <tbody>
                     @foreach( $stock_list ?: [] as $i => $v )
                        ...
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 300px;">{{ $v['goods_spec'] ?: '无' }}</div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;">{{ $v['order_sn'] ?: "N/A" }}</div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">{{ $v['stock'] }}</div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">@if(tp_empty($v['order_sn'])) 货品库存@else商品库存 @endif </div>
                            </td>
                            <td align="center" class="">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 130px;">{{ date("Y-m-d H:i:s",$v['ctime']) }}</div>
                            </td>
