              ...
              <tr data-id="{{ $list['id'] }}">
                ...
                <td align="left" class="">
                  <div style="text-align: left; width: 100px;">
	                  <a href="{{ $list['logo'] ?: $list['logo']:'/public/images/icon_goods_thumb_empty_300.png' }}" target="_blank"><img onMouseOver="$(this).attr('width','80').attr('height','45');" onMouseOut="$(this).attr('width','40').attr('height','30');" width="40" height="30" src="{{ $list['logo'] ?: $list['logo']:'/public/images/icon_goods_thumb_empty_300.png' }}"/></a>
                  </div>
                </td>
