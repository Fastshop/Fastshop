...
.recigle .copyright{color: #3c8dbc;}
	...
	<body class="tranjump">
		<div class="rectangle_box">
			...
			<div class="recigle">
				<p>Copyright©2014-2017<em class="copyright"><a class="copyright" href="http://www.tpshop.cn/">{{ $tpshop_config['shop_info_store_name'] ?: 'TPshop商城' }} v2.0.0</a></em></p>
				<p><em class="copyright"><a class="copyright" href="http://www.tpshop.cn/">{{ $tpshop_config['shop_info_store_name'] ?: 'TPshop商城' }}</a></em>出品</p>
			</div>
		</div>
