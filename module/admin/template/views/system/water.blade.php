    ...
    <form method="post" id="handlepost" action="{{ U('System/handle') }}">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="is_mark1" class="cb-enable @if($config['is_mark'] == 1) selected @endif " >开启</label>
                        <label for="is_mark0" class="cb-disable @if($config['is_mark'] == 0) selected @endif " >关闭</label>
                        <input id="is_mark1" name="is_mark" value="1" @if($config['is_mark'] == 1) checked @endif  type="radio">
                        <input id="is_mark0" name="is_mark" value="0" @if($config['is_mark'] == 0) checked @endif  type="radio">
                    </div>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="mark_type1" class="cb-enable @if($config['mark_type'] == 'text') selected @endif " >文字</label>
                        <label for="mark_type0" class="cb-disable @if($config['mark_type'] == 'img') selected @endif " >图片</label>
                        <input id="mark_type1" onclick="setwarter('text')" name="mark_type" value="text" @if($config['mark_type'] == 'text') checked @endif  type="radio">
                        <input id="mark_type0" onclick="setwarter('img')" name="mark_type"  value="img" @if($config['mark_type'] == 'img') checked @endif  type="radio">
                    </div>
            ...
            <dl class="row texttr" style="display:none;">
                ...
                <dd class="opt">
                    <input name="mark_txt_size" id="mark_txt" value="{{ $config['mark_txt_size'] ?: 30 }}" class="input-txt" type="text" />
            ...
            <dl class="row texttr" style="display:none;">
                ...
                <dd class="opt">
                    <input name="mark_txt_color" id="mark_txt" value="{{ $config['mark_txt_color'] ?: '#000000' }}" class="input-txt" type="text" />
                            ...
                            <span class="span_1">
                                <ul>
                                    <li><input type="radio" name="sel" value="1"
                                        @if($config['sel'] == '1') checked @endif 
                                        >&nbsp;顶部居左
                                    </li>
                                    <li><input type="radio" name="sel" value="4"
                                        @if($config['sel'] == '4') checked @endif 
                                        >&nbsp;中部居左
                                    </li>
                                    <li><input type="radio" name="sel" value="7"
                                        @if($config['sel'] == '7') checked @endif 
                                        >&nbsp;底部居左
                                    </li>
                                </ul>
                            </span>
                            <span class="span_1">
                                <ul>
                                    <li><input type="radio" name="sel" value="2"
                                        @if($config['sel'] == '2') checked @endif 
                                        >&nbsp;顶部居中
                                    </li>
                                    <li><input type="radio" name="sel" value="5"
                                        @if($config['sel'] == '5') checked @endif 
                                        >&nbsp;中部居中
                                    </li>
                                    <li><input type="radio" name="sel" value="8"
                                        @if($config['sel'] == '8') checked @endif 
                                        >&nbsp;底部居中
                                    </li>
                                </ul>
                            </span>
                            <span class="span_1">
                                <ul>
                                    <li><input type="radio" name="sel" value="3"
                                        @if($config['sel'] == '3') checked @endif 
                                        >&nbsp;顶部居右
                                    </li>
                                    <li><input type="radio" name="sel" value="6"
                                        @if($config['sel'] == '6') checked @endif 
                                        >&nbsp;中部居右
                                    </li>
                                    <li><input type="radio" name="sel" value="9"
                                        @if($config['sel'] == '9') checked @endif 
                                        >&nbsp;底部居右
                                    </li>
                                </ul>
                            </span>
