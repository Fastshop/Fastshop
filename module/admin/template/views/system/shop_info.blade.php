        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="store_logo_a" target="_blank" class="nyroModal" rel="gal" href="{{ $config['store_logo'] ?: '/public/static/images/logo/pc_home_logo_default.png' }}">
                                <i id="store_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['store_logo'] ?: '/public/static/images/logo/pc_home_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="store_logo" name="store_logo" value="{{ $config['store_logo'] ?: '/public/static/images/logo/pc_home_logo_default.png' }}" class="type-file-text">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="store_user_logo_a" class="nyroModal" rel="gal" href="{{ $config['store_user_logo'] ?: '/public/static/images/logo/pc_home_user_logo_default.png' }}">
                                <i id="store_user_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['store_user_logo'] ?: '/public/static/images/logo/pc_home_user_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="store_user_logo" name="store_user_logo" value="{{ $config['store_user_logo'] ?: '/public/static/images/logo/pc_home_user_logo_default.png' }}" class="type-file-text">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="storeico_a" target="_blank" class="nyroModal" rel="gal" href="{{ $config['store_ico'] }}">
                                <i id="storeico_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['store_ico'] }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="store_ico" name="store_ico" value="{{ $config['store_ico'] }}" class="type-file-text">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="admin_login_logo_a" class="nyroModal" rel="gal" href="{{ $config['admin_login_logo'] ?: '/public/static/images/logo/admin_login_logo_default.png' }}">
                                <i id="admin_login_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['admin_login_logo'] ?: '/public/static/images/logo/admin_login_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="admin_login_logo" name="admin_login_logo" value="{{ $config['admin_login_logo'] ?: '/public/static/images/logo/admin_login_logo_default.png' }}" class="type-file-text">
                            <input type="button" name="button" value="选择上传..." class="type-file-button">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="admin_home_logo_a" class="nyroModal" rel="gal" href="{{ $config['admin_home_logo'] ?: '/public/static/images/logo/admin_home_logo_default.png' }}">
                                <i id="admin_home_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['admin_home_logo'] ?: '/public/static/images/logo/admin_home_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="admin_home_logo" name="admin_home_logo" value="{{ $config['admin_home_logo'] ?: '/public/static/images/logo/admin_home_logo_default.png' }}" class="type-file-text">
                            <input type="button" name="button" value="选择上传..." class="type-file-button">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="wap_home_logo_a" class="nyroModal" rel="gal" href="{{ $config['wap_home_logo'] ?: '/public/static/images/logo/wap_home_logo_default.png' }}">
                                <i id="wap_home_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['wap_home_logo'] ?: '/public/static/images/logo/wap_home_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="wap_home_logo" name="wap_home_logo" value="{{ $config['wap_home_logo'] ?: '/public/static/images/logo/wap_home_logo_default.png' }}" class="type-file-text">
                            <input type="button" name="button" value="选择上传..." class="type-file-button">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="input-file-show">
                        <span class="show">
                            <a id="wap_login_logo_a" class="nyroModal" rel="gal" href="{{ $config['wap_login_logo'] ?: '/public/static/images/logo/wap_logo_default.png' }}">
                                <i id="wap_login_logo_i" class="fa fa-picture-o" onmouseover="layer.tips('<img src={{ $config['wap_login_logo'] ?: '/public/static/images/logo/wap_logo_default.png' }}>',this,{tips: [1, '#fff']});" onmouseout="layer.closeAll();"></i>
                            </a>
                        </span>
           	            <span class="type-file-box">
                            <input type="text" id="wap_login_logo" name="wap_login_logo" value="{{ $config['wap_login_logo'] ?: '/public/static/images/logo/wap_logo_default.png' }}" class="type-file-text">
                            <input type="button" name="button" value="选择上传..." class="type-file-button">
                    ...
                    <select onchange="get_city(this)" id="province" name="province">
                        <option  value="0">选择省份</option>
                         @foreach( $province ?: [] as $i => $vo )
                            ...
                            <option value="{{ $vo['id'] }}" @if($config['province'] == $vo['id']) selected @endif >{{ $vo['name'] }}</option>
                    ...
                    <select onchange="get_area(this);" id="city" name="city">
                        <option value="0">选择城市</option>
                         @foreach( $city ?: [] as $i => $vo )
                            ...
                            <option value="{{ $vo['id'] }}" @if($config['city'] == $vo['id']) selected @endif >{{ $vo['name'] }}</option>
                    ...
                    <select id="district" name="district">
                        <option value="0">选择区域</option>
                         @foreach( $area ?: [] as $i => $vo )
                            ...
                            <option value="{{ $vo['id'] }}" @if($config['district'] == $vo['id']) selected @endif >{{ $vo['name'] }}</option>
