...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
          ...
          media="screen"/>
    <title>{{ $tpshop_config['shop_info_store_name'] ?: 'Tpshop商城' }}</title>
...
<div class="admincp-header">
    ...
    <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
        ...
        <img style="height: 28px"
             src="{{ $tpshop_config['shop_info_admin_home_logo'] ?: '/public/static/images/logo/admin_home_logo_default.png' }}"
             alt="">
    </div>
    ...
    <div class="admincp-header-r">
        <div class="manager">
            ...
            @if($upgradeMsg['0'] != null)
                <dl style="text-align:left; font-size:15px;">
                    <dd class="group"><a href="javascript:void(0);" id="a_upgrade"
                                         style="color:#FF0;">{{ $upgradeMsg['0'] }}</a></dd>
                </dl>
        @endif
        <!--服务器升级 end-->
            <dl>
			...
			<img alt="" tptype="admin_avatar" src="/public/static/images/admint.png"> </span><i class="arrow"
            ...
            <div class="manager-menu">
                <div class="title">
                    ...
                    <a href="javascript:void(0);"
                       onClick="CUR_DIALOG = ajax_form('modifypw', '修改密码', '{{ U('Admin/modify_pwd',array('admin_id'=>$admin_info['admin_id'])) }}');"
        ...
        <div class="operate bgd-opa">
            ...
            <ul class="bgdopa-list">
                <li style="display: none !important;" tptype="pending_matters"><a class="toast show-option"
                                                                                  href="javascript:void(0);"
                                                                                  onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://www.tpshop.cn/admin/index.php?act=common&op=pending_matters', '480');"
                                                                                  title="查看待处理事项">&nbsp;<em>0</em></a>
                </li>
                <li><a class="login-out show-option" href="{{ U('Admin/logout') }}"><img
                                src="/public/static/images/icon-exit.png">退出系统</a></li>
                <li><a class="sitemap show-option" id="trace_show" href="{{ U('System/cleanCache',array('quick'=>1)) }}"
                       target="workspace"><img src="/public/static/images/cle-cache.png">更新缓存</a></li>
                <li><a class="switch-smpro" href="http://wx.tp-shop.cn/client"><img
                                src="/public/static/images/icon-switch.png" style="margin-top:0;">切换小程序</a></li>
                <li><a class="homepage show-option" target="_blank" href="/"><img
                                src="/public/static/images/icon-home.png">打开商城</a></li>
...
<div class="admincp-container unfold">
    <div class="admincp-container-left">
        ...
        <div id="admincpNavTabs_index" class="nav-tabs">
            <dl>
                <dt><a href="javascript:void(0);"><span class="ico-microshop-1"></span>
                        <h3>概览</h3></a></dt>
                <dd class="sub-menu">
                    <ul>
        ...
        @foreach( $menu ?: [] as $mk => $vo )
            ...
            <div id="admincpNavTabs_{{ $mk }}" class="nav-tabs">
                @foreach( $vo['child'] ?: [] as $key => $v2 )
                    ...
                    <dl>
                        <dt><a href="javascript:void(0);"><span class="ico-{{ $mk }}-{{ $key }}"></span>
                                <h3>{{ $v2['name'] }}</h3></a></dt>
                        <dd class="sub-menu">
                            <ul>
                                @foreach( $v2['child'] ?: [] as $key => $v3 )
                                    ...
                                    <li><a href="javascript:void(0);"
                                           data-param="{{ $v3['act'] }}|{{ $v3['op'] }}">{{ $v3['name'] }}</a></li>
        ...
        <div class="about" title="关于系统"
             onclick="javascript:layer.open({type: 2,title: '关于我们',shadeClose: true,shade: 0.3,area: ['50%', '60%'],content:'{{ U("Index/about") }}', });">
            <i class="fa fa-copyright"></i><span>tpshop.cn</span></div>
    </div>
