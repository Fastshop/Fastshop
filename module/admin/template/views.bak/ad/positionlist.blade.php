...
<script>	
    ...
    function copyToClipBoard(id, limit) {
      ...
      contentdiv += '<dd><input type="text" style=" width:400px;" value="<script type=&quot;text/javascript&quot; src=&quot;http://' + '{{ \think\Request::instance()->server('http_host') }}' + '/index.php?m=Home&amp;c=Api&amp;a=ad_show&amp;pid=' + id + '&amp;limit='+limit+'&quot;><\/script>"></dd>'
