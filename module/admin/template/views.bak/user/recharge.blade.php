                    ...
                    <tbody>
                     @foreach( $lists ?: [] as $i => $list )
                        ...
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;">{{ date("Y-m-d H:i",$list['ctime']) }}</div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">{{ $list['pay_name'] }}</div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">@if($list['pay_status'] == 0) 待支付@else已支付 @endif </div>
                            </td>
