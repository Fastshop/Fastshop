                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2" style="margin-right: 10px;border: none;">
                        <select id="status" name="status" class="form-control">
                            <option value=""  @if($_REQUEST['status'] == '') selected @endif >状态</option>
                            <option value="-1" @if($_REQUEST['status'] == -1) selected @endif >审核失败</option>
                            <option value="0" @if($_REQUEST['status'] === '0') selected @endif >待审核</option>
                            <option value="1" @if($_REQUEST['status'] == 1) selected @endif >申请成功</option>
                        </select>
                    </div>
                    <div class="sDiv2" style="margin-right: 10px;">
                        ...
                        <tr>
                            <td align="center" class="">
                                ...
                                <div style="text-align: center; width: 50px;">
                                    @if($v['status'] == 0) <input type="checkbox" name="selected[]" value="{{ $v['id'] }}"> @endif 
                                </div></label>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 50px;">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 150px;">{{ date("Y-m-d H:i:s",$v['create_time']) }}</div>
                            </td>
                            <td align="center" class="">
