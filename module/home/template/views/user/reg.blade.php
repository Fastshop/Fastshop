    ...
    <div class="regcon">
        ...
        <div class="ui_tab">
            <ul class="ui_tab_nav regnav">
                <li class="uli @if(I('get.t') == '') active @endif  "><a href="{{ U('Home/User/reg') }}" >手机注册</a></li>
                <li class="uli @if(I('get.t') == 'email') active @endif  "><a href="{{ U('Home/User/reg',array('t'=>'email')) }}">邮箱注册</a></li>
                <li class="no fn-fr loginbtn">我已注册，马上<a href="{{ U('Home/User/login') }}">登录></a></li>
            </ul>
            
@if(\think\Request::instance()->param('t') == '') 
		<form id="reg_form2"  method="post" action="">
            <input type="hidden" name="auth_code" value="{{ \think\Config::get('AUTH_CODE') }}"/>
                        ...
                        <div class="line">
                            ...
                            <div class="liner">
                                ...
                                <img width="100" height="35" src="/index.php/Home/User/verify/type/user_reg.html" id="reflsh_code2" class="po-ab to0">
                                    <a><img onclick="verify('reflsh_code2')" src="/assets/static/images/chg_image.png" class="ma-le-210"></a>
                            </div>
                            <div id="show-voice" class="show-voice"></div>
                        </div>
                   @if($tpshop_config['sms_regis_sms_enable'] == 1) 
                        <div class="line">
                    ...
                    @endif 
                        ...
                        @if($tpshop_config['integral_invite'] == 1) 
                        <div class="line">
 ...
 @endif 
@if(\think\Request::instance()->param('t') == 'email') 
		<form id="reg_form2"  method="post" action="">
            <input type="hidden" name="auth_code" value="{{ \think\Config::get('AUTH_CODE') }}"/>
            <div class="ui_tab_content">
                <div class="m-fnbox ui_panel" style="display: block;">
...
<script>
    ...
    var t ="{{ \think\Request::instance()->param('t') }}";
        ...
        $.ajax({
            ...
            success: function(res){
            	if(res.status == 1)
    			{
    				...
    				intAs = {{ $tpshop_config['sms_sms_time_out'] ?: 60 }}; // 手机短信超时时间
