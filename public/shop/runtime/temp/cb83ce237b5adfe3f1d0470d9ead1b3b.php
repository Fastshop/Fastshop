<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view/system/basic.html";i:1540260088;s:84:"/Users/Shared/wwwroot/demo.pro/public/shop/application/admin/view/public/layout.html";i:1540260088;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form method="post" enctype="multipart/form-data" name="form1" action="<?php echo U('System/handle'); ?>">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="switch1" class="cb-enable  <?php if($config['invite'] == 1): ?>selected<?php endif; ?>">开启</label>
                        <label for="switch0" class="cb-disable <?php if($config['invite'] == 0): ?>selected<?php endif; ?>">关闭</label>
                        <input type="radio" onclick="$('#switch_on_off').show();"  id="switch1"  name="invite" value="1" <?php if($config['invite'] == 1): ?>checked="checked"<?php endif; ?>>
                        <input type="radio" onclick="$('#switch_on_off').hide();" id="switch0" name="invite" value="0" <?php if($config['invite'] == 0): ?>checked="checked"<?php endif; ?> >
                    </div>
                </dd>
            </dl>
            <dl class="row">
                ...
                <dd class="opt">
                    <input onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" pattern="^\d{1,}$" id="invite_integral" name="invite_integral" value="<?php echo (isset($config['invite_integral']) && ($config['invite_integral'] !== '')?$config['invite_integral']:0); ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="rechargevip_on_off1" class="cb-enable  <?php if($config['rechargevip_on_off'] == 1): ?>selected<?php endif; ?>">开启</label>
                        <label for="rechargevip_on_off0" class="cb-disable <?php if($config['rechargevip_on_off'] == 0): ?>selected<?php endif; ?>">关闭</label>
                        <input type="radio" onclick="$('#switch_on_off').show();"  id="rechargevip_on_off1"  name="rechargevip_on_off" value="1" <?php if($config['rechargevip_on_off'] == 1): ?>checked="checked"<?php endif; ?>>
                        <input type="radio" onclick="$('#switch_on_off').hide();" id="rechargevip_on_off0" name="rechargevip_on_off" value="0" <?php if($config['rechargevip_on_off'] == 0): ?>checked="checked"<?php endif; ?> >
                    </div>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" pattern="^\d{1,}$" id="rechargevip_price" name="rechargevip_price" value="<?php echo (isset($config['rechargevip_price']) && ($config['rechargevip_price'] !== '')?$config['rechargevip_price']:0); ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <div class="onoff">
                        <label for="rechargevip_rebate_on_off1" class="cb-enable  <?php if($config['rechargevip_rebate_on_off'] == 1): ?>selected<?php endif; ?>">开启</label>
                        <label for="rechargevip_rebate_on_off0" class="cb-disable <?php if($config['rechargevip_rebate_on_off'] == 0): ?>selected<?php endif; ?>">关闭</label>
                        <input type="radio" onclick="$('#switch_on_off').show();"  id="rechargevip_rebate_on_off1"  name="rechargevip_rebate_on_off" value="1" <?php if($config['rechargevip_rebate_on_off'] == 1): ?>checked="checked"<?php endif; ?>>
                        <input type="radio" onclick="$('#switch_on_off').hide();" id="rechargevip_rebate_on_off0" name="rechargevip_rebate_on_off" value="0" <?php if($config['rechargevip_rebate_on_off'] == 0): ?>checked="checked"<?php endif; ?> >
                    </div>
                </dd>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" pattern="^\d{1,}$" id="rechargevip_rebate" name="rechargevip_rebate" value="<?php echo (isset($config['rechargevip_rebate']) && ($config['rechargevip_rebate'] !== '')?$config['rechargevip_rebate']:0); ?>" class="input-txt" type="text">
                    <span class="err">只能输入整数</span>
            ...
            <dl class="row">
                ...
                <dd class="opt im">
                    ...
                    <input type="radio" name="im_choose"  id="tpshop-im" value="1" <?php if($config['im_choose'] == 1): ?> checked <?php endif; ?> >TPshop im客服  &nbsp;&nbsp;&nbsp;&nbsp;
			...
			<dl class="row" id="tpshop-im-web" <?php if($config['im_choose'] != 1): ?> style="display: none" <?php endif; ?> >
                ...
                <dd class="opt">
                    <input id="im_website" name="im_website" value="<?php echo $config['im_website']; ?>" class="input-txt" type="text" placeholder="例如：im.tp-shop.cn">
