<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./template/pc/rainbow/goods/integralmall.html";i:1540260094;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/header.html";i:1561094141;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/footer.html";i:1540260094;s:87:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/sidebar_cart.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="UTF-8">
...
<div class="tpshop-tm-hander">
	...
	<div class="nav w1224 clearfix">
					...
					<div class="item">
						...
						<div class="cata-nav-layer">
							<div class="cata-nav-left">
								 <!-- 如果没有热门分类就隐藏 --> 
								 <?php if(count((array)$v['hot_cate']) < 1): endif; ?>
								<div class="cata-layer-title" <?php if(count((array)$v['hot_cate']) == 0): ?>style="display:none"<?php endif; ?>>
							...
							<div class="advertisement_down">
								<?php foreach( tpl_adv("","5","","v3","key","100+$kr") as $key => $v3 ): ?>
							...
							<?php foreach( tpl_adv("","1","","az","key","51") as $key => $az ): ?>
		...
		<ul class="navitems clearfix" id="navitems">
			...
			<?php foreach(tpl_query("SELECT * FROM `__PREFIX__navigation` where is_show = 1 and position = 'top' ORDER BY `sort` DESC") as $k=>$v): ?>
			...
			<div class="w1224">
				<div class="stsho pre-sts intergra">
					<div class="sx_topb presellall">
						<div class="f-sort fl">
							<ul>
								<li <?php if(\think\Request::instance()->param('brandType') == '0'): ?>class="red"<?php endif; ?>><a href="<?php echo U('Home/Goods/integralMall',array('id'=>I('get.id'),'brandType'=>0)); ?>">全部<i class="jta jta-w"></i></a></li>
								<li <?php if(\think\Request::instance()->param('brandType') == '1'): ?>class="red"<?php endif; ?>><a href="<?php echo U('Home/Goods/integralMall',array('id'=>I('get.id'),'brandType'=>1)); ?>">积分+金额<i class="jta"></i></a></li>
								<li <?php if(\think\Request::instance()->param('brandType') == '2'): ?>class="red"<?php endif; ?>><a href="<?php echo U('Home/Goods/integralMall',array('id'=>I('get.id'),'brandType'=>2)); ?>">全积分<i class="jta"></i></a></li>
							</ul>
						</div>
					...
					<div class="reco-bouti">
						...
						<div class="reacommque">
							<ul>
								<?php foreach(tpl_query("select * from `__PREFIX__goods` where is_on_sale = 1 and exchange_integral > 0 and is_recommend = 1 and is_virtual = 0 limit 5") as $k=>$goods): ?>
									<li>
									<div class="boxque">
										<img src="<?php echo goods_thum_images($goods['goods_id'],165,188); ?>"/>
										<p class="shop_name"><a href=""><?php echo $goods['goods_name']; ?></a></p>
										<div class="coan-j p">
											<div class="fl">
												<p class="ckf">参考价：￥<span class="lithe"><?php echo $goods['shop_price']; ?></span></p>
												<p class="ckf">换购价：<span class="red">￥<em>
                                                    <!--<?php echo $goods['exchange_integral_price']; ?>-->
                                                    <!--+<?php echo $goods['exchange_integral']; ?>-->
												<?php 
													if(empty($point_rate)) $point_rate = 10;
													$integral_price = $goods['shop_price']-$goods['exchange_integral']/$point_rate;
													echo round($integral_price,2)."+".$goods['exchange_integral'];
					...
					<div class="hotchane">
						...
						<div class="hot-change">
							<ul>
								<?php foreach(tpl_query("select * from `__PREFIX__goods` where is_on_sale = 1 and exchange_integral > 0 and is_hot = 1 and is_virtual = 0 limit 7") as $k=>$goods): ?>
...
<div class="footer">
	<div class="w1224 clearfix" style="padding-bottom: 10px;">
		<div class="left-help-list">
			<div class="help-list-wrap clearfix">
				<?php foreach(tpl_query("select * from `__PREFIX__article_cat` where cat_id < 6  order by sort_order asc") as $k=>$v): ?>
					<dl>
						<dt><?php echo $v['cat_name']; ?></dt>
						<?php foreach(tpl_query("select * from `__PREFIX__article` where cat_id = $v[cat_id]  and is_open=1 limit 5") as $k2=>$v2): ?>
			...
			<div class="friendship-links clearfix">
                ...
                <?php foreach(tpl_query("select * from `__PREFIX__friend_link` where is_show=1") as $k=>$v): ?>
    ...
    <div class="mod_copyright p">
        <div class="grid-top">
            <?php foreach(tpl_query("SELECT * FROM `__PREFIX__navigation` where is_show = 1 AND position = 'bottom' ORDER BY `sort` DESC") as $kk=>$vv): ?>
            ...
            <!--<?php foreach(tpl_query("select * from `__PREFIX__article` where cat_id = 5 and is_open=1") as $k=>$v): ?>-->
                <!--<a href="<?php echo U('Home/Article/detail',array('article_id'=>$v['article_id'])); ?>"><?php echo $v['title']; ?></a>-->
                <!--<span>|</span>-->
            <!--<?php endforeach; ?>-->
        </div>
        <p>Copyright © 2016-2025 <?php echo (isset($tpshop_config['shop_info_store_name']) && ($tpshop_config['shop_info_store_name'] !== '')?$tpshop_config['shop_info_store_name']:'TPshop商城'); ?> 版权所有 保留一切权利 备案号:<a href="http://www.miitbeian.gov.cn" ><?php echo $tpshop_config['shop_info_record_no']; ?></a></p>
