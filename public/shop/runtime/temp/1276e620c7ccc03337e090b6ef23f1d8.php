<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./template/pc/rainbow/goods/goodslist.html";i:1561094141;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/header.html";i:1561094141;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/footer.html";i:1540260094;s:87:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/sidebar_cart.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="UTF-8">
                ...
                <dl class="brand-section m-tr">
                    ...
                    <dd class="ri-section">
                            ...
                            <div class="brand-box brand-list">
                                <div class="clearfix p">
                                    <?php if(is_array($filter_brand) || $filter_brand instanceof \think\Collection || $filter_brand instanceof \think\Paginator): if( count($filter_brand)==0 ) : echo "" ;else: foreach($filter_brand as $k=>$v): ?>
                                        <a href="<?php echo $v['href']; ?>" data-href="<?php echo $v['href']; ?>"  data-key='brand' data-val='<?php echo $v['id']; ?>' style="line-height: 33px;">
                                            <i class="litt-zd"></i>
                        ...
                        <div class="lr-more">
                            ...
                            <?php if(count((array)$filter_brand) > 10): ?>
                                <a href="javascript:void(0)"><span class="gd_more">更多</span><i class="litt-tcr"></i></a>
                            <?php endif; ?>
                        </div>
                    </dd>
            ...
            <?php if(is_array($filter_attr) || $filter_attr instanceof \think\Collection || $filter_attr instanceof \think\Paginator): if( count($filter_attr)==0 ) : echo "" ;else: foreach($filter_attr as $k=>$v): ?>
                <dl class="brand-section m-tr">
                    ...
                    <dd class="ri-section">
                        ...
                        <div class="lr-more">
                            <a href="javascript:void(0)"><span class="dx_choice">多选</span><i class="litt-pluscr"></i></a>
                            <?php if(count((array)$v['attr_value']) > 11): ?>
                                <a href="javascript:void(0)"><span class="gd_more">更多</span><i class="litt-tcr"></i></a>
                            <?php endif; ?>
                        </div>
                    </dd>
	...
	<div class="w1430">
		<div class="tjhot fl">
			...
			<div class="tjhot-shoplist" id="ajax_hot_goods">
                <?php foreach(tpl_query("select goods_id,goods_name,shop_price from `__PREFIX__goods` where is_hot=1 and is_on_sale = 1 limit 5") as $k=>$vo): ?>
                    <div class="alone-shop">
                        <a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$vo['goods_id'])); ?>" target="_blank"><img class="lazy" data-original="<?php echo goods_thum_images($vo['goods_id'],180,180); ?>"/></a>
