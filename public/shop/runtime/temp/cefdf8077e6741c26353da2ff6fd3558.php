<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:46:"./application/admin/view/uploadify/upload.html";i:1540260088;}*/ ?>
<html lang="zh-cn">
<head>
...
$(function(){
    ...
    var fileType = "<?php echo (isset($info['fileType']) && ($info['fileType'] !== '')?$info['fileType']:'Images'); ?>";
	...
	$(".statusBar .saveBtn").click(function(){
		...
		var elementid = "<?php echo $info['input']; ?>";
