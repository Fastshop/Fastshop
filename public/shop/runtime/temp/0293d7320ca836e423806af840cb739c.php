<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:38:"./template/pc/rainbow/index/index.html";i:1540260094;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/header.html";i:1561094141;s:81:"/Users/Shared/wwwroot/demo.pro/public/shop/template/pc/rainbow/public/footer.html";i:1540260094;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="myCarousel" class="carousel clearfix">
	<ul class="carousel-inner">
        <?php foreach( tpl_adv("","5","","v1","key","2") as $key => $v1 ): ?>
	...
	<?php foreach( tpl_adv("","2","","vb","key","52") as $key => $vb ): ?>
...
<div class="adv3 w1224 clearfix">
	<?php foreach( tpl_adv("","3","","vr","key","50") as $key => $vr ): ?>
...
<?php foreach( tpl_adv("","1","","v5","key","49") as $key => $v5 ): ?>
...
<div class="slidebar-right">
	...
	<a class="slidebar-item ico-slidebar3" target="_blank" href="javascript:;" >
		...
		<div class="sbar-hover-pic">
			<div class="qrcode-wrap"><img class="w-100" img-url="/index.php?m=Home&c=Index&a=qr_code&data=<?php echo $mobile_url; ?>&head_pic=<?php echo $head_pic; ?>&back_img=<?php echo $back_img; ?>" alt="" /></div>
